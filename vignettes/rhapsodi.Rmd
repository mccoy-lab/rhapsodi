...
Because so many combinations of the parameters exist, a single example call will be provided here. For this example, assume that we are running rhapsodi on the *pre-loaded dataframe* `rhapsodi_dt_acgt` which is A/C/G/T/NA encoded.
