...
#' @param window_size User-input value for length of segment
#' @param overlap_denom User-input value for denominator in calculation of overlap, or the degree of overlap between segments
#'
